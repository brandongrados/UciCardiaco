...
using UciCardiaco.Web.Models.Usuarios.Usuario;
...
namespace UciCardiaco.Web.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController(DbContextUciCardiaco context,IConfiguration config)
        {
            _context = context;
            _config = config;
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model)
        {
            ...
            //con 3 claim en asp y 3 en view claim son las reclamaciones contienen informacion del usuario 
            //"es el usuario y no lo que el usuario pueda ser"
            return Ok(
